...
import dk.bluebox.demo.githubviewer.network.ServiceFactory.Companion.BASE_URL
import dk.bluebox.demo.githubviewer.network.ServiceFactory.Companion.TIMEOUT_SECCONDS
