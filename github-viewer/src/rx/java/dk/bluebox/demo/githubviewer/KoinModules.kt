...
import dk.bluebox.demo.githubviewer.rx.data.room.AppDatabase
...
import dk.bluebox.demo.githubviewer.rx.domain.details.DetailsInteractorImpl
import dk.bluebox.demo.githubviewer.rx.domain.list.ListInteractor
import dk.bluebox.demo.githubviewer.rx.domain.list.ListInteractorImpl
import dk.bluebox.demo.githubviewer.rx.network.GitHubApi
import dk.bluebox.demo.githubviewer.rx.network.GitHubApiImpl
...
import dk.bluebox.demo.githubviewer.rx.network.ServiceFactoryImpl
...
import dk.bluebox.demo.githubviewer.rx.ui.details.DetailsViewModelImpl
import dk.bluebox.demo.githubviewer.common.ui.list.ListViewModel
import dk.bluebox.demo.githubviewer.rx.data.room.RoomGitHubRepository
import dk.bluebox.demo.githubviewer.rx.ui.list.ListViewModelImpl
