...
import dk.bluebox.demo.githubviewer.flow.concatFlows
import dk.bluebox.demo.githubviewer.flow.firstFlow
...
class DefaultGitHubRepository(private val api: GitHubApi) : GitHubRepository {
    ...
    override fun getRepositories(): Flow<List<Repository>> {
        ...
        return concatFlows(cacheFlow, networkFlow).firstFlow()
    }
